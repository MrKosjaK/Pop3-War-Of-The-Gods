...
function OnTurn()
  if (EVERY_2POW_TURNS(11)) then
    ...
    if (attack_idx == 0) then
      ...
      if (who_i_attack ~= 3) then
        if (_gsi.Players[TRIBE_PINK].NumPeople > 30) then
          ATTACK(TRIBE_PINK, who_i_attack, 6+G_RANDOM(4), ATTACK_BUILDING, T_MODEL_NONE, 100+G_RANDOM(300), M_SPELL_NONE, M_SPELL_NONE, M_SPELL_NONE, ATTACK_NORMAL, 0, 16, NO_MARKER, NO_MARKER)
        end
      else
        if (_gsi.Players[TRIBE_PINK].NumPeople > 30 and GET_HEIGHT_AT_POS(2) < 512) then
          ATTACK(TRIBE_PINK, who_i_attack, 6+G_RANDOM(4), ATTACK_BUILDING, T_MODEL_NONE, 100+G_RANDOM(300), M_SPELL_NONE, M_SPELL_NONE, M_SPELL_NONE, ATTACK_NORMAL, 0, 10, NO_MARKER, NO_MARKER)
        end
      end
    elseif (attack_idx == 1) then
      ...
      if (who_i_attack ~= 3) then
        if (_gsi.Players[TRIBE_PINK].NumPeople > 30) then
          ATTACK(TRIBE_PINK, who_i_attack, 5+G_RANDOM(7), ATTACK_BUILDING, T_MODEL_NONE, 100+G_RANDOM(300), M_SPELL_INSECT_PLAGUE, M_SPELL_INSECT_PLAGUE, M_SPELL_LIGHTNING_BOLT, ATTACK_NORMAL, 0, 16, NO_MARKER, NO_MARKER)
        end
      else
        if (_gsi.Players[TRIBE_PINK].NumPeople > 20 and GET_HEIGHT_AT_POS(2) < 512) then
          ATTACK(TRIBE_PINK, who_i_attack, 5+G_RANDOM(7), ATTACK_BUILDING, T_MODEL_NONE, 100+G_RANDOM(300), M_SPELL_INSECT_PLAGUE, M_SPELL_INSECT_PLAGUE, M_SPELL_LIGHTNING_BOLT, ATTACK_NORMAL, 0, 10, NO_MARKER, NO_MARKER)
        end
      end
    elseif (attack_idx == 2) then
      ...
      if (who_i_attack ~= 3) then
        if (_gsi.Players[TRIBE_PINK].NumPeople > 45) then
          ATTACK(TRIBE_PINK, who_i_attack, 11+G_RANDOM(11), ATTACK_BUILDING, T_MODEL_NONE, 100+G_RANDOM(300), M_SPELL_INSECT_PLAGUE, M_SPELL_INSECT_PLAGUE, M_SPELL_LIGHTNING_BOLT, ATTACK_NORMAL, 0, 16, NO_MARKER, NO_MARKER)
        end
      else
        if (_gsi.Players[TRIBE_PINK].NumPeople > 45 and GET_HEIGHT_AT_POS(2) < 512) then
          ATTACK(TRIBE_PINK, who_i_attack, 11+G_RANDOM(11), ATTACK_BUILDING, T_MODEL_NONE, 100+G_RANDOM(300), M_SPELL_INSECT_PLAGUE, M_SPELL_INSECT_PLAGUE, M_SPELL_LIGHTNING_BOLT, ATTACK_NORMAL, 0, 10, NO_MARKER, NO_MARKER)
        end
      end
    elseif (attack_idx == 3) then
      ...
      if (who_i_attack ~= 3) then
        if (_gsi.Players[TRIBE_PINK].NumPeople > 40) then
          ATTACK(TRIBE_PINK, who_i_attack, 6+G_RANDOM(9), ATTACK_BUILDING, T_MODEL_NONE, 100+G_RANDOM(300), M_SPELL_NONE, M_SPELL_NONE, M_SPELL_NONE, ATTACK_NORMAL, 0, 16, NO_MARKER, NO_MARKER)
        end
      else
        if (_gsi.Players[TRIBE_PINK].NumPeople > 40 and GET_HEIGHT_AT_POS(2) < 512) then
          ATTACK(TRIBE_PINK, who_i_attack, 6+G_RANDOM(9), ATTACK_BUILDING, T_MODEL_NONE, 100+G_RANDOM(300), M_SPELL_NONE, M_SPELL_NONE, M_SPELL_NONE, ATTACK_NORMAL, 0, 10, NO_MARKER, NO_MARKER)
        end
      end
    end
  end
      ...
      if (PLAYERS_PEOPLE_OF_TYPE(TRIBE_PINK, M_PERSON_WARRIOR) > 4 and _gsi.Players[TRIBE_PINK].NumPeople > 55) then
        ...
        if (who_i_attack == 3) then
          if (GET_HEIGHT_AT_POS(2) < 512) then
            ATTACK(TRIBE_PINK, who_i_attack, 2+G_RANDOM(4), ATTACK_BUILDING, T_MODEL_NONE, 200+G_RANDOM(300), M_SPELL_NONE, M_SPELL_NONE, M_SPELL_NONE, ATTACK_NORMAL, 0, 10, NO_MARKER, NO_MARKER)
          end
        else
          ATTACK(TRIBE_PINK, who_i_attack, 2+G_RANDOM(4), ATTACK_BUILDING, T_MODEL_NONE, 200+G_RANDOM(300), M_SPELL_NONE, M_SPELL_NONE, M_SPELL_NONE, ATTACK_NORMAL, 0, 16, NO_MARKER, NO_MARKER)
        end
      end
