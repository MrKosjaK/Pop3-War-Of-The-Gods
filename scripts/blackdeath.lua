...
function OnTurn()
  if (EVERY_2POW_TURNS(10)) then
    if (statue_has_prayed == TRUE) then
      ...
      if (final_blow == FALSE and winner == TRIBE_BLACK) then
        ...
        ATTACK(TRIBE_BLACK, TRIBE_BLUE, 25, ATTACK_BUILDING, T_MODEL_NONE, 999, M_SPELL_NONE, M_SPELL_NONE, M_SPELL_NONE, ATTACK_NORMAL, 0, NO_MARKER, NO_MARKER, NO_MARKER)
        ATTACK(TRIBE_BLACK, TRIBE_RED, 25, ATTACK_BUILDING, T_MODEL_NONE, 999, M_SPELL_NONE, M_SPELL_NONE, M_SPELL_NONE, ATTACK_NORMAL, 0, NO_MARKER, NO_MARKER, NO_MARKER)
        final_blow = TRUE
      end
    end
  end
  ...
  if (EVERY_2POW_TURNS(8)) then
    ...
    if (statue_has_prayed == TRUE and winner == TRIBE_BLACK) then
      ...
      ATTACK(TRIBE_BLACK, G_RANDOM(2), 5, ATTACK_BUILDING, T_MODEL_NONE, 999, M_SPELL_NONE, M_SPELL_NONE, M_SPELL_NONE, ATTACK_NORMAL, 0, NO_MARKER, NO_MARKER, NO_MARKER)
    end
