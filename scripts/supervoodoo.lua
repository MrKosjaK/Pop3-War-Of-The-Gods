...
function OnTurn()
    ...
    if (PLAYERS_PEOPLE_OF_TYPE(TRIBE_CYAN, M_PERSON_WARRIOR) > 3 and
      ...
      if (attacks == 0) then
        ...
        if (who_shall_attack == TRIBE_ORANGE) then
          ...
          ATTACK(TRIBE_CYAN, who_shall_attack, 4+G_RANDOM(18), ATTACK_BUILDING, T_MODEL_NONE, 999, spell1, spell2, M_SPELL_INSECT_PLAGUE, ATTACK_NORMAL, 0, 26, marker, NO_MARKER)
        else
          WRITE_CP_ATTRIB(TRIBE_CYAN, ATTR_AWAY_MEDICINE_MAN, 100)
          WRITE_CP_ATTRIB(TRIBE_CYAN, ATTR_AWAY_WARRIOR, G_RANDOM(100))
          WRITE_CP_ATTRIB(TRIBE_CYAN, ATTR_AWAY_RELIGIOUS, G_RANDOM(100))
          ATTACK(TRIBE_CYAN, who_shall_attack, 4+G_RANDOM(18), ATTACK_BUILDING, T_MODEL_NONE, 999, spell2, spell2, M_SPELL_INSECT_PLAGUE, ATTACK_NORMAL, 0, 20+G_RANDOM(2), NO_MARKER, NO_MARKER)
        end
      elseif (attacks == 1) then
        ...
        if (who_shall_attack == TRIBE_ORANGE) then
          ...
          WRITE_CP_ATTRIB(TRIBE_CYAN, ATTR_AWAY_WARRIOR, G_RANDOM(100))
          WRITE_CP_ATTRIB(TRIBE_CYAN, ATTR_AWAY_RELIGIOUS, G_RANDOM(100))
          ATTACK(TRIBE_CYAN, who_shall_attack, 5+G_RANDOM(24), ATTACK_BUILDING, T_MODEL_NONE, 999, spell1, spell2, M_SPELL_INSECT_PLAGUE, ATTACK_NORMAL, 0, 28, marker, NO_MARKER)
        else
          WRITE_CP_ATTRIB(TRIBE_CYAN, ATTR_AWAY_MEDICINE_MAN, 100)
          WRITE_CP_ATTRIB(TRIBE_CYAN, ATTR_AWAY_WARRIOR, G_RANDOM(100))
          WRITE_CP_ATTRIB(TRIBE_CYAN, ATTR_AWAY_RELIGIOUS, G_RANDOM(100))
          ATTACK(TRIBE_CYAN, who_shall_attack, 5+G_RANDOM(24), ATTACK_BUILDING, T_MODEL_NONE, 999, spell2, spell2, M_SPELL_INSECT_PLAGUE, ATTACK_NORMAL, 0, 20+G_RANDOM(2), NO_MARKER, NO_MARKER)
        end
      end
    end
    ...
    if (PLAYERS_PEOPLE_OF_TYPE(TRIBE_ORANGE, M_PERSON_WARRIOR) > 3 and
      ...
      if (attacks == 0) then
        ...
        if (who_shall_attack == TRIBE_YELLOW) then
          ...
          ATTACK(TRIBE_ORANGE, who_shall_attack, 5+G_RANDOM(24), ATTACK_BUILDING, T_MODEL_NONE, 999, spell1, spell2, M_SPELL_INSECT_PLAGUE, ATTACK_NORMAL, 0, 3, marker, NO_MARKER)
        else
          if (GET_HEIGHT_AT_POS(25) > 0) then
            WRITE_CP_ATTRIB(TRIBE_ORANGE, ATTR_AWAY_MEDICINE_MAN, 100)
            WRITE_CP_ATTRIB(TRIBE_ORANGE, ATTR_AWAY_WARRIOR, G_RANDOM(100))
            WRITE_CP_ATTRIB(TRIBE_ORANGE, ATTR_AWAY_RELIGIOUS, G_RANDOM(100))
            ATTACK(TRIBE_ORANGE, who_shall_attack, 5+G_RANDOM(24), ATTACK_BUILDING, T_MODEL_NONE, 999, spell2, spell2, M_SPELL_INSECT_PLAGUE, ATTACK_NORMAL, 0, 29, 28, NO_MARKER)
          end
        end
      elseif (attacks == 1) then
        local spell2 = M_SPELL_LIGHTNING_BOLT
        ...
        if (who_shall_attack == TRIBE_YELLOW) then
          ...
          if (GET_HEIGHT_AT_POS(24) > 0) then
            ...
            WRITE_CP_ATTRIB(TRIBE_ORANGE, ATTR_AWAY_WARRIOR, G_RANDOM(100))
            WRITE_CP_ATTRIB(TRIBE_ORANGE, ATTR_AWAY_RELIGIOUS, G_RANDOM(100))
            ATTACK(TRIBE_ORANGE, who_shall_attack, 5+G_RANDOM(24), ATTACK_BUILDING, T_MODEL_NONE, 999, spell2, spell2, M_SPELL_INSECT_PLAGUE, ATTACK_NORMAL, 0, 27, 26, NO_MARKER)
          end
        end
      end
    end
  ...
  if (_gsi.Counts.GameTurn > tickCyanLiteAttack) then
    ...
    if (_gsi.Players[TRIBE_CYAN].NumPeople > 60) then
      ...
      ATTACK(TRIBE_CYAN, who_shall_attack, 2+G_RANDOM(7), ATTACK_BUILDING, T_MODEL_NONE, 459, M_SPELL_NONE, M_SPELL_NONE, M_SPELL_NONE, ATTACK_NORMAL, 0, NO_MARKER, NO_MARKER, NO_MARKER)
    end
  elseif (_gsi.Counts.GameTurn > tickOrangeLiteAttack) then
    ...
    if (_gsi.Players[TRIBE_ORANGE].NumPeople > 60) then
      ...
      ATTACK(TRIBE_ORANGE, who_shall_attack, 2+G_RANDOM(7), ATTACK_BUILDING, T_MODEL_NONE, 459, M_SPELL_NONE, M_SPELL_NONE, M_SPELL_NONE, ATTACK_NORMAL, 0, NO_MARKER, NO_MARKER, NO_MARKER)
    end
  end
