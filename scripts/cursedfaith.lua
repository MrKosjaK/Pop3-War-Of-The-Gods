  ...
  if (every2Pow(11) and GetTurn() > 120) then
    ...
    if (attack_idx == 0) then
      if (GET_HEIGHT_AT_POS(9) == 0) then
        WRITE_CP_ATTRIB(TRIBE_ORANGE, ATTR_AWAY_MEDICINE_MAN, 100)
        ATTACK(TRIBE_ORANGE, G_RANDOM(2), 3+G_RANDOM(12), ATTACK_BUILDING, -1, 250+G_RANDOM(700), M_SPELL_LAND_BRIDGE, M_SPELL_INSECT_PLAGUE, M_SPELL_INSECT_PLAGUE, ATTACK_NORMAL, 0, 10, 11, NO_MARKER)
      else
        WRITE_CP_ATTRIB(TRIBE_ORANGE, ATTR_AWAY_MEDICINE_MAN, 100)
        ATTACK(TRIBE_ORANGE, G_RANDOM(2), 4+G_RANDOM(12), ATTACK_BUILDING, -1, 250+G_RANDOM(700), M_SPELL_BLAST, M_SPELL_INSECT_PLAGUE, M_SPELL_INSECT_PLAGUE, ATTACK_NORMAL, 0, 10, NO_MARKER, NO_MARKER)
      end
    elseif (attack_idx == 1) then
      ATTACK(TRIBE_ORANGE, G_RANDOM(2), 4+G_RANDOM(12), ATTACK_BUILDING, -1, 250+G_RANDOM(700), M_SPELL_INSECT_PLAGUE, M_SPELL_INSECT_PLAGUE, M_SPELL_INSECT_PLAGUE, ATTACK_NORMAL, 0, NO_MARKER, NO_MARKER, NO_MARKER)
    elseif (attack_idx == 2) then
      if (_gsi.Players[TRIBE_ORANGE].NumPeople > 60) then
        ATTACK(TRIBE_ORANGE, G_RANDOM(2), 12+G_RANDOM(18), ATTACK_BUILDING, -1, 250+G_RANDOM(700), M_SPELL_INSECT_PLAGUE, M_SPELL_INSECT_PLAGUE, M_SPELL_INSECT_PLAGUE, ATTACK_NORMAL, 0, NO_MARKER, NO_MARKER, NO_MARKER)
      else
          ATTACK(TRIBE_ORANGE, G_RANDOM(2), 4+G_RANDOM(12), ATTACK_BUILDING, -1, 250+G_RANDOM(700), M_SPELL_INSECT_PLAGUE, M_SPELL_INSECT_PLAGUE, M_SPELL_INSECT_PLAGUE, ATTACK_NORMAL, 0, NO_MARKER, NO_MARKER, NO_MARKER)
      end
    end
